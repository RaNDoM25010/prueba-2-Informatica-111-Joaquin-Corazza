"""
Programación I – Segundo Parcial
Ejercicio Integrador: Archivos, Matrices, Diccionarios y Funciones
"""

VOCALES = {"A", "E", "I", "O", "U"}


# --- Función 1: Leer una linea del archivo y convertirla en matriz 3x3 ---
...
# --- Función 2: Mostrar una matriz 3x3 con formato matricial ---
...
# --- Función 3: Generar una nueva matriz 3x3 con solo las vocales encontradas ---
...
# --- Función 4: Actualizar el diccionario de estadísticas con las vocales de la matriz ---
...
# --- Función 5: Procesar una sola linea del archivo (leer, convertir, mostrar, actualizar) ---
...
# --- Función 6: Mostrar el resumen final de estadisticas ---
def mostrar_resumen(estadisticas, total_matrices):
    ...
    print(f"Matrices procesadas: {total_matrices}")
